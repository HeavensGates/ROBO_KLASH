/*  Robo Klash
 ...
 This game makes use of sound librabry you can download it from the tools section
 in libraries. Search for sound.
 */
//Sound Files
...
void draw() {
  ...
  if (mainMenu) {
    ...
    text("Please turn on your sound to hear the game",375,450,420,100);
    textSize(50);
